    ...
    <>
      ...
      <div>
        ...
        <div className="flex flex-col col-span-1 lg:col-span-2 mb-4">
          <h2 className="font-bold text-black mb-3 mt-5 fs-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-4 mt-3 mb-4">
          <div className="grid grid-cols-3 col-span-3">
            <label className="font-medium text-black dark:text-white mb-1 pb-2 col-span-1 text-justify">
        ...
        <h2 className="font-bold text-black mb-4 mt-4 fs-8">
      ...
      <div>
        <h2 className="font-bold text-black text-center mb-2 mt-4 fs-4 p-2">
          Annexure A - Applicable only for multiple sites (please fill
          separately for each site.)
        </h2>
        <h2 className="font-bold text-black mb-2 mt-4 fs-8">1. Site Details</h2>
